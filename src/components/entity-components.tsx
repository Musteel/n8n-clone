...
export const EntityHeader = ({ title, description, onNewClick, newButtonHref, newButtonLabel, disabled, isCreating }: EntityHeaderProps) => {
    return (
...
export const EntitySearch = ({ value, onChange, placeholder }: EntitySearchProps) => {
    return (
        <div className="relative ml-auto">
            <SearchIcon className="size-4 absolute left-3 top-2 translate-y-0.5 text-muted-foreground" />
            <Input
